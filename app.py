...
st.sidebar.write(
    """
    ციფრულ სამყაროში  ერთ-ერთი ყველაზე გავრცელებული პრობლემა გენდერის ნიშნით სიძულვილის ენის გამოყენება და სიძულვილით მოტივირებული ძალადობაა,ძალადობა რომელიც ქალებისა და კაცების მიმართ სხვადასხვანაირად ვლინდება-ხოლმე. Საერთაშორისო კვლევებით დასტურდება, რომ ქალების მიმართ ამგვარი ძალადობა უფრო ხშირია და ციფრულ სამყაროში მათი აქტიურობისა და თანასწორი რეპრეზანტაციის წინაღობა ხდება.
        ევროსაბჭოსა და DataFest Tbilisi 2023-ის პარტნიორობით ორგანიზებული ჰაკათონის ფარგლებში შეიქმნა ხელოვნური ინტელექტის მოდელი, რომელსაც შეუძლია დააიდენტიფიციროს  სიძულვილის ენა ქართულენოვან ტექსტებში. Ამ მოდელის გამოყენება ემსახურება ქართული ინტერნეტსივრცის კვლევას, გენდერის ნიშნით  ძალადობის აღმოჩენასა და ანალიზს.
        ...
        ხელსაწყოს  შესაძლებლობები არის შეზღუდული მწირი რესურსების გამო, რადგან ChatGPT-ის მსგავსი მოდელი, რომელსაც საკმაოდ დიდი შესაძლებლობები აქვს, არ არსებობს ქართული ენისთვის.
    """
)
